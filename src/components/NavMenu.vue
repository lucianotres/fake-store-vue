...
<template>
  ...
  <div class="{{!collapseNavMenu.value ?? 'collapse'}} nav-scrollable" @click="toggleNavMenu">
    <nav class="flex-column">
      ...
      <div class="nav-item px-3">
        <RouterLink class="nav-link" to="/produtos" active-class="active">
          <span class="bi bi-list-nested-nav-menu" aria-hidden="true"></span> Produtos
        </RouterLink>
      </div>
      <div class="nav-item px-3">
        <RouterLink class="nav-link" to="/usuarios" active-class="active">
          <span class="bi bi-list-nested-nav-menu" aria-hidden="true"></span> Usuários
        </RouterLink>
      </div>
      <div class="nav-item px-3">
        <RouterLink class="nav-link" to="/carrinhos" active-class="active">
          <span class="bi bi-list-nested-nav-menu" aria-hidden="true"></span> Carrinhos
        </RouterLink>
      </div>
    </nav>
  </div>
